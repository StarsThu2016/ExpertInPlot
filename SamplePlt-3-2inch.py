...
plt.axes().set_xticklabels(labels = [str(x) for x in np.arange(1, 10)], fontsize = 8)
...
plt.axes().set_yticklabels(labels = [str(x) for x in np.arange(1000, 10000, 1000)], fontsize = 8)
